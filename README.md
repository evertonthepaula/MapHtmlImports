...
você quer testar? Eu provo que fuciona, execute ``npm i && npm run server``, acesse http://localhost:3000/ e veja a magica acontecer.

Estou rodando dentro de um servidor para evitar problemas com CORS.